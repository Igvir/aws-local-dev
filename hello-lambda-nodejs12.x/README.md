...
```bash
hello-lambda-nodejs12.x$ sam build
```
...
```bash
hello-lambda-nodejs12.x$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
hello-lambda-nodejs12.x$ sam local start-api
hello-lambda-nodejs12.x$ curl http://localhost:3000/
```
...
```bash
hello-lambda-nodejs12.x$ sam logs -n HelloWorldFunction --stack-name hello-lambda-nodejs12.x --tail
```
...
```bash
hello-lambda-nodejs12.x$ cd hello-world
...
```bash
aws cloudformation delete-stack --stack-name hello-lambda-nodejs12.x
```
